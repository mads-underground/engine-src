...
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/1x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/1.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/1x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/2x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/2.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/2x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/3x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/3.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/3x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/4x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/4.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/4x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/5x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/5.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/5x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/6x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/6.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/6x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/7x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/7.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/7x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/8x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/8.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/8x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
<span class="thumbnail-wrapper d32 circular bg-success">
<img width="34" height="34" alt="" data-src-retina="{{asset('assets/vendors/assets/img/profiles/9x.jpg')}}" data-src="{{asset('assets/vendors/assets/img/profiles/9.jpg')}}" src="{{asset('assets/vendors/assets/img/profiles/9x.jpg')}}" class="col-top">
</span>
<p class="p-l-10 ">
...
<img class="col-top" width="30" height="30" src="{{asset('assets/vendors/assets/img/profiles/avatar_small.jpg')}}" alt="" data-src="{{asset('assets/vendors/assets/img/profiles/avatar_small.jpg')}}" data-src-retina="{{asset('assets/vendors/assets/img/profiles/avatar_small2x.jpg')}}">
</div>
...
<div class="col-6 ">
<a class="btn-toggle-layout fs-12 active " data-action="menuDefault" href="#"><img alt="Menu divided icon" class="m-b-15" src="{{asset('assets/vendors/assets/img/demo/menu_divided_con.png')}}" data-src="{{asset('assets/vendors/assets/img/demo/menu_divided_con.png')}}" data-src-retina="{{asset('assets/vendors/assets/img/demo/menu_divided_con_2x.png')}}" width="126" height="95">
<span class="text-dark m-t-5">Divided Header & Condensed / Quick
Menu</span></a>
</div>
<div class="col-6">
<a class="btn-toggle-layout fs-12" data-action="menuBelow" href="#">
<img alt="Full header icon" class="m-b-15 " src="{{asset('assets/vendors/assets/img/demo/full_header_con.png')}}" data-src-retina="{{asset('assets/vendors/assets/img/demo/full_header_con_2x.png')}}" width="126" height="95"> <span class="text-dark m-t-5">Full Width Header & Condensed/ Quick
Menu</span></a>
</div>
</div>
</div>
...
<img alt="Theme default" src="{{asset('assets/vendors/assets/img/demo/theme_default.png')}}" class="image-responsive-height">
...
<img alt="Theme corporate" src="{{asset('assets/vendors/assets/img/demo/theme_corporate.png')}}" class="image-responsive-height">
<div class="p-l-15 p-r-20 p-b-10 p-t-10">
<p class="no-margin">
...
<img alt="Theme retro" src="{{asset('assets/vendors/assets/img/demo/theme_retro.png')}}" class="image-responsive-height">
<div class="p-l-15 p-r-20 p-b-10 p-t-10">
<p class="no-margin">
...
<img alt="Theme unlax" src="{{asset('assets/vendors/assets/img/demo/theme_unlax.png')}}" class="image-responsive-height">
<div class="p-l-15 p-r-20 p-b-10 p-t-10">
<p class="no-margin">
...
<img alt="Thmeme vibes" src="{{asset('assets/vendors/assets/img/demo/theme_vibes.png')}}" class="image-responsive-height">
<div class="p-l-15 p-r-20 p-b-10 p-t-10">
<p class="no-margin">
...
<img alt="Theme abstract" src="{{asset('assets/vendors/assets/img/demo/theme_abstract.png')}}" class="image-responsive-height">
<div class="p-l-15 p-r-20 p-b-10 p-t-10">
<p class="no-margin">
